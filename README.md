...
>백엔드 개발자로 참여하면서 이미지 저장 오류와 로그인 문제 등 실제 서비스 환경에서 발생하는 문제들을 직접 해결해보며 큰 성장을 느꼈습니다.
>EC2 폴더 설정, 멀티파트 방식 적용, 키 해시 등록 등 다양한 기술을 다뤄볼 수 있었고, 팀원들과의 역할 분담도 잘 이루어졌습니다.
>다만, 기능 간 연동 테스트가 다소 늦어졌던 점은 아쉬움으로 남습니다.
>이번 프로젝트를 통해 웹 백엔드 개발에 확신을 가지게 되었고, 배포 및 서버 운영 경험이 취업 준비에 실질적인 도움이 되었습니다.
